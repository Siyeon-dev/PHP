...
// delete.php 에서 password 를 입력받고, 삭제 버튼이 눌러졌을 때, runDelete 를 실행합니다.
...
function runDelete($beforePage, $afterPage) {
  ...
  if (boardSettings::IS_CHECK_PASSWORD) {
    ...
    $postData = getPostOnDB($boardIdType, $_POST[nameOfPostData::BOARD_ID]);
    ...
    if (comparePassword($postData[1]->user_passwd, $_POST[nameOfPostData::USER_PW])) {
      $IS_COMPARE_OK = true;
