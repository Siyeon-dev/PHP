...
<body>
  <fieldset style="border: 1 solid">
    ...
    <form action="#" method="POST">
      ...
      <input type="text" id="userId" name="<?php echo nameOfPostData::USER_ID ?>" value="<?php echo $postData[1]->user_name ?>">
      <label for="userPw">비밀번호</label>
      <input type="password" id="userPw" name="<?php echo nameOfPostData::USER_PW ?>" value="">
