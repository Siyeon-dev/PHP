...
function runModify($argPostObj, $argPwFromUser) {
  ...
  // 유효성 검사 진행
  if (checkInputValue([nameOfPostData::BOARD_TITLE, nameOfPostData::BOARD_CONTENTS, nameOfPostData::BOARD_ID]))
    $IS_VALID_OK = true;
